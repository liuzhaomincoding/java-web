...
public class AstuteLayoutViewResolver extends AstuteViewResolver {
	 ...
	 */
	@Override
	protected Class<AstuteLayoutView> requiredViewClass() {
		return AstuteLayoutView.class;
	}
	...
	protected AbstractUrlBasedView buildView(String viewName) throws Exception {
		AstuteLayoutView view = (AstuteLayoutView) super.buildView(viewName);
